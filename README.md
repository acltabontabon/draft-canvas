...
**Draw** — Double-click to create shapes (text, notes, services, databases, queues, actors). Drag
from an edge to connect; drop on empty canvas and the target node appears.
