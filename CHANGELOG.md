...
- **Saving can't damage a file**: each save is written to a temporary file first and swapped in, and a
  file changed by something else is never overwritten without asking.
...
- The installers aren't signed with a paid certificate, so your OS asks once before opening it — see
  below.
- This alpha updates to later alphas and then to 1.10.0 on its own.
...
[1.10.0-alpha.1]: https://github.com/acltabontabon/draft-canvas/compare/v1.9.4...desktop-v1.10.0-alpha.1
