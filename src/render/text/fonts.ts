...
export const FONTS = {
  ...
  freeTextHeading: { stack: 'sans', size: TEXT_SIZES.freeTextHeading, weight: 600 } satisfies FontSpec,
  freeTextTitle: { stack: 'sans', size: TEXT_SIZES.freeTextTitle, weight: 700 } satisfies FontSpec,
  freeTextTechnical: { stack: 'mono', size: TEXT_SIZES.freeTextTechnical, weight: 500 } satisfies FontSpec,
