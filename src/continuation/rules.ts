 ...
 * is no evidence check because there is no quiet case: this is the list `]` cycles through, most
 * common first, with `rank.ts` pushing down what the anchor already does (a Service already writing
