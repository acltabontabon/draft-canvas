...
export const RECIPES = [
  ...
  },
  {
    ...
    category: 'flows',
    keywords: ['present', 'presentation', 'slides', 'demo', 'meeting', 'walkthrough', 'play', 'fullscreen', 'next step', 'switch flow'],
    keys: [['mod', 'enter'], ['right'], ['shift', 'right'], ['esc']],
    note: 'Shift+→ starts the next flow without leaving — Shift+F jumps to any of them.',
  ...
  },
  {
    ...
    summary: 'Keep the big picture big — draw the detail one level down.',
    category: 'architecture',
    keywords: [
      'inside',
      'look inside',
